...
import type { Nullable, IServer } from './types';

export type ServerParent = OpenAPI | PathItem;

export type ServerReference = Reference<Server, ServerParent>;
 ...
 */
export class Server extends BasicNode<ServerParent> implements IServer {
  private mUrl: string;
